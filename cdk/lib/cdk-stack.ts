...
export class CdkStack extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    dynamoDbTables.runningStreamsTable.grantReadData(lambdaFunctions.checkRunningStreamsFunction);
    dynamoDbTables.runningStreamsTable.grantWriteData(lambdaFunctions.updateRunningStreamsFunction);
    ...
    dynamoDbTables.runningInstancesTable.grantReadWriteData(lambdaFunctions.terminateEC2Function);

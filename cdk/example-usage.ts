...
export async function exampleUsage() {
  ...
  const streamsWrapper = createDynamoDbWrapper('streams', dynamoDbTables.RunningStreamsTable);
  const instancesWrapper = createDynamoDbWrapper('instances', dynamoDbTables.runningInstancesTable);

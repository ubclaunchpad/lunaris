...
describe('Workflow Utilities', () => {
  ...
  describe('createStandardErrorHandling', () => {
    test('should create standard error handling with service errors', () => {
      ...
      expect(config.customErrorStates!['Lambda.ServiceException']).toBe('HandleLambdaServiceError');
      expect(config.customErrorStates!['DynamoDB.ServiceException']).toBe('HandleDynamoDBError');
    });
  ...
  describe('validateWorkflowConfig', () => {
    ...
    test('should throw error for missing name', () => {
      ...
      expect(() => validateWorkflowConfig(invalidConfig)).toThrow('must have a non-empty name');
    });
  ...
  describe('validateLambdaFunctionRef', () => {
    test('should validate valid Lambda function reference', () => {
      ...
      expect(() => validateLambdaFunctionRef('TestWorkflow', 'step1', validRef)).not.toThrow();
    });
